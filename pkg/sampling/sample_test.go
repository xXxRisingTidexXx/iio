...
var _ = Describe("sample", func() {
	...
	Context("comparison", func() {
		...
		With("shouldn't equal `cause of different labels", func() {
			Expect(
				cmp.Equal(
		...
		With("shouldn't equal `cause of total difference", func() {
			Expect(
				cmp.Equal(
		...
		With("should equal with shared vector", func() {
		...
		With("should equal with equal-by-value vectors", func() {
			Expect(
				cmp.Equal(
